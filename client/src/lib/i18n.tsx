...
function i18nKeyToCms(key: string): { section: string; blockKey: string } | null {
  ...
  const mappings: Record<string, { section: string; blockKey: string }> = {
    ...
    // WhyPropline section
    "whyddl.badge": { section: "whyPropline", blockKey: "badge" },
    "whyddl.heading": { section: "whyPropline", blockKey: "title" },
    "whyddl.subheading": { section: "whyPropline", blockKey: "subtitle" },
    "whyddl.quote1": { section: "whyPropline", blockKey: "quote" },
    "whyddl.reason1.title": { section: "whyPropline", blockKey: "reason1_title" },
    "whyddl.reason1.desc": { section: "whyPropline", blockKey: "reason1_desc" },
    "whyddl.reason2.title": { section: "whyPropline", blockKey: "reason2_title" },
    "whyddl.reason2.desc": { section: "whyPropline", blockKey: "reason2_desc" },
    "whyddl.reason3.title": { section: "whyPropline", blockKey: "reason3_title" },
    "whyddl.reason3.desc": { section: "whyPropline", blockKey: "reason3_desc" },
    "whyddl.reason4.title": { section: "whyPropline", blockKey: "reason4_title" },
    "whyddl.reason4.desc": { section: "whyPropline", blockKey: "reason4_desc" },
    "whyddl.reason5.title": { section: "whyPropline", blockKey: "reason5_title" },
    "whyddl.reason5.desc": { section: "whyPropline", blockKey: "reason5_desc" },
    "whyddl.reason6.title": { section: "whyPropline", blockKey: "reason6_title" },
    "whyddl.reason6.desc": { section: "whyPropline", blockKey: "reason6_desc" },
    // WhyDubai section
...
const translations: Record<Language, Record<string, string>> = {
  he: {
    ...
    "about.subtitle": "PropLine - הדרך שלך להשקעה חכמה בדובאי",
    ...
    "about.badge": "אודות PropLine",
    "about.heading": "מי אנחנו",
    "about.p1": "PropLine היא חברת ליווי להשקעות נדל״ן בדובאי. אנחנו מתמחים בליווי משקיעים פרטיים בהשקעות נדל״ן בדובאי – מהשלב הראשון ועד לאחר סגירת העסקה.",
  ...
  en: {
    ...
    "about.subtitle": "PropLine - Your Path to Smart Investment in Dubai",
    ...
    "about.badge": "About PropLine",
    "about.heading": "Who We Are",
    "about.p1": "PropLine is a real estate investment guidance company in Dubai. We specialize in guiding private investors in Dubai real estate investments – from the first step to after closing the deal.",
